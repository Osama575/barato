                ...
                {carouselData.map((item, index) => (
                    <CarouselItem key={index}>
                        <div style={{backgroundImage: `url(${item.image})`}} className='w-full lg:h-[450px] h-[400px] relative bg-cover bg-no-repeat'>
                            ...
                            <div className='absolute z-10 lg:top-1/4 lg:right-20 inset-0 text-right flex flex-col lg:items-end items-center justify-center lg:justify-start lg:gap-4 gap-4 backdrop-blur-sm backdrop-opacity-30 lg:backdrop-opacity-0  bg-black/50 lg:bg-transparent'>
